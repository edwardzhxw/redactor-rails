			...
			return {
				...
				loadTemplates: function()
				{
					this.opts.modal = {
						...
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-author" name="transcript" value="author">&nbsp;author bio</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-company" name="transcript" value="company">&nbsp;company desc</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-speaker" name="transcript" value="speaker">&nbsp;Speaker’s biography</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-fda" name="transcript" value="fda">&nbsp;FDA product information resource</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-institutions" name="transcript" value="institutions">&nbsp;Government & academic institutions</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-stock" name="transcript" value="stock">&nbsp;Multinational company stock price data</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-corporate" name="transcript" value="corporate">&nbsp;Offical corporate website</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-nih" name="transcript" value="nih">&nbsp;Generic drug information (NIH)</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-product" name="transcript" value="product">&nbsp;Corporate pharma product resource</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-device" name="transcript" value="device">&nbsp;Corporate medical device resource</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-information" name="transcript" value="information">&nbsp;Third-party information resource</label>'
						+ '<label class="redactor-modal-link-radio" ><input type="radio" id="redactor-link-radio-resource" name="transcript" value="resource">&nbsp;Media resource</label>'
						+ '</section>'
					};
